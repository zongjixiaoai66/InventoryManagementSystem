...
//            return R.error(511,"永远不会进入");
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<GongyinghsangEntity> gongyinghsangList = new ArrayList<>();//上传的东西
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            GongyinghsangEntity gongyinghsangEntity = new GongyinghsangEntity();
//                            gongyinghsangEntity.setGongyinghsangName(data.get(0));                    //供应商名称 要改的
//                            gongyinghsangEntity.setGongyinghsangTypes(Integer.valueOf(data.get(0)));   //供应商类型 要改的
//                            gongyinghsangEntity.setGongyinghsangXinyongTypes(Integer.valueOf(data.get(0)));   //供应商信用等级名称 要改的
//                            gongyinghsangEntity.setInsertTime(date);//时间
//                            gongyinghsangEntity.setGongyinghsangContent("");//详情和图片
//                            gongyinghsangEntity.setCreateTime(date);//时间
                            gongyinghsangList.add(gongyinghsangEntity);
                        ...
                        //查询是否重复
                        gongyinghsangService.insertBatch(gongyinghsangList);
                        return R.ok();
                    }
                }
            }
